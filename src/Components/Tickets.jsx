  ...
  return (
    <div className='pt-[64px]'>
        ...
        <div className='flex flex-col text-[#fff] lg:pb-[164px]'>
           ...
           <button className='flex flex-row mt-[40px] text-[#000] border border-[#000] justify-center items-center gap-[8px] rounded-[48px] py-[17px] px-[30px] bg-[#FFFAEB] max-w-[293px]'>
